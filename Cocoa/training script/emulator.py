...
def train(model, scheduler, optimizer, trainload, valload, N_epoch, covinv, device, X_mean, X_std, Y_mean, Y_std, PATH):
    losses_train = []
    losses_vali = []
    losses_train_med = []
    losses_vali_med = []
    ...
    for n in range(N_epoch):
        ...
        for i, data in enumerate(trainload):
            ...
            Y_pred_back = Y_pred*As[:,None]/exptau[:,None]
        ...
        with torch.no_grad():
            ...
            print('Reduce LR on plateu: ',True)
